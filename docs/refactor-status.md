...
| T13 | T06/T11/T12 | G | implementing | Q3 可信 UI 固定交接、当前实例发现、范围 API、候选 diff/taskChanges、后台页真实输入、试跑与撤销自动客户端通过；安装版 skill 和全新 Agent 验收待 Q5/Q6 |
| T14 | 持续 | S0/G | implementing | Q3 54 文件/326 项、类型检查/构建、固定交接和系统专项通过；当前代码完整旧桌面矩阵三次失败需 Q4 定位，30 分钟新架构长测未跑 |
